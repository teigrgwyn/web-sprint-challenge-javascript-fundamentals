...
*/
function CuboidMaker(obj) { // it's implied we're accepting values for properties in the instructions, not an object :\
...
// let box = new CubeMaker(5);
// console.log(box.length + " " + box.width + " " + box.height);
